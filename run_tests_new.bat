...
echo --------------------------
python tests/run_tests_new.py --type basic --verbose
if %ERRORLEVEL% neq 0 (
...
echo --------------------------
python tests/run_tests_new.py --type integration --skip-gpu --verbose
if %ERRORLEVEL% neq 0 (
...
echo ----------------------------
python tests/run_tests_new.py --type all --coverage --output reports/coverage
if %ERRORLEVEL% neq 0 (
